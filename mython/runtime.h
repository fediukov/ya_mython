...
namespace runtime {
    ...
    // Context - Контекст исполнения инструкций Mython ------------------------/
    class Context {
    public:
    ...
    // Object - Базовый класс для всех объектов языка Mython ------------------/
    class Object {
    public:
    ...
    // ObjectHolder - Специальный класс-обёртка, предназначенный ---------------
    // для хранения объекта в Mython-программе --------------------------------/
    class ObjectHolder {
    public:
    ...
    // ValueObject - Объект-значение, хранящий значение типа T ----------------/
    template <typename T>
    ...
    // ClassInstance - Экземпляр класса ---------------------------------------/
    ...
    std::optional<R> IsComparable(const ObjectHolder& lhs, const ObjectHolder& rhs, F comparator) {
